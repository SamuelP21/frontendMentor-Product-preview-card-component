  ...
  return (
    <div>
      <main className='flex justify-center items-center min-h-screen bg-rose-50 p-10 '>
        <article className='lg:flex lg:flex-row min-[320px]:flex-col bg-white rounded-lg lg:w-[55%] lg:space-x-8 lg:pr-8'>
          <div className='basis-1/2 min-[320px]:hidden lg:block'>
              <img className='rounded-l-lg h-[100%] '  src={image1} alt="imagen colonia" />
          </div>
          <div className=' lg:hidden min-[320px]:block'>
